...
public class LuceneSpatial {
    ...
    private String indexPath = "lucene-spatial-all";
...
//                System.out.println(d);
    ...
    public List<String> searchBasic(String keyword) throws Exception {
        initializeSpatialOptions();
        List<String> result = new ArrayList<String>();
        Query query = buildQuery(keyword);
        indexDirectory = FSDirectory.open(new File(indexPath));
    ...
    public static void main(String args[]){
        LuceneSpatial test = new LuceneSpatial();
        try {
            test.init();
        } catch (Exception e) {
            e.printStackTrace();
